...
A normal safe uses a combination lock; the RFID Lockbox uses an RFID tag sensor and tag to control the lock. The project you will see below uses this mechanism to unlock and lock the safe through a solenoid, which, in simple terms, is a magnet that can be turned off and on; the RFID tag is inserted into a slot where it is read by the RFID tag sensor, and if it isn't the correct tag, then it will be kept in the safe. If the correct tag is inserted and read, then it will turn the solenoid off and thus allow the user to open the safe to retrieve or place their valuables inside. 

| **Engineer** | **School** | **Area of Interest** | **Grade** |
|:--:|:--:|:--:|:--:|
| Xinkun L. | Canyon Crest Academy | Electrical Engineering | Incoming Junior

![Headstone Image](docs/assets/css/Headstone.png)
  
# Final Milestone

<iframe width="560" height="315" src="https://www.youtube.com/embed/4_vnGlnVsUM?si=ZIRXwX-7y9QcSSpV" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Since completing milestone two, I have made many modifications to the RFID Lockbox, including a one-minute lockout, a 4x4 membrane keypad, a buzzer to make sound, and many other changes to the code. One example of a change in the code includes all the new additions to the security mechanism, including a one-minute lockdown, a second verification step that comes from entering a PIN, and the many new flashes of the LEDs that come with it. Another example of a change in the code includes the new addition of sounds to almost every interaction the user has with the lockbox. These interactions include button presses, scanning right and wrong RFID tags, the one-minute lockout with a siren noise, an admin state for changing the PIN, noises for the 10-second timer to enter your PIN, and noises for when you enter the right and wrong PIN. Some of my biggest challenges I’ve faced during my time in BSE were the limitations of my materials. My project didn’t have an outline of what to do, which meant that everything I did had to be researched and tested. Due to my lack of experience with most of the materials I had, mistakes were going to happen, and I would have to learn through trial and error. But because I was able to learn this way, it greatly expanded my knowledge of my materials as I figured out how they work and what unique ways I could use them. One major example of this was the voltage and current problem I faced starting from the second milestone. Due to my project using two high-voltage and current drains—the solenoid and servo motor—I had to find another way to power them because a 9V battery wouldn’t be enough. Not only that, but due to the high current draw, I also couldn’t use a mini breadboard to connect the power supply to them in the first place. All of this meant that I had to both find another power supply and a new way of connecting it to them, which led to the four AA battery power supply and the lever nuts solution that took a lot of research to figure out. But despite it being one of the biggest problems I faced, solving it became one of my biggest triumphs during BSE. Being able to solve a problem through my own research and seeing it work is why I value it as one of my biggest triumphs during BSE. Overall, throughout my time at BSE, I have learned many things, such as how to wire a solenoid, how a 4x4 membrane keypad works, how code works in Arduino IDE, and how to navigate GitHub. But overall, I learned a lot about how the engineering process works: how many problems arise, how you have to research everything about your project and parts to get everything to work, how many components and steps there are in the entire process, as well as the trips and stumbles that come from the problems and the feeling of success once you conquer a massive roadblock. In the future, I am hoping to learn more about the tools, materials, skills, and everything else that has to do with engineering. I’m still relatively new to the field, with some knowledge I’ve gained through various things, including BSE, but I believe that there are plenty more things I need to learn before I can become, hopefully, an electrical engineer. In the meantime, I hope to build on what I’ve learned about the engineering process from BSE through mini projects or something else. All in all, I’ve had a good time, have learned a lot from my experience at BSE, and hope to continue down the path of an electrical engineer.
